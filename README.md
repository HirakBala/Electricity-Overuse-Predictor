...
Hosted on Streamlit Cloud (24×7 access)
User Input → Model Output
Inputs: daily appliance usage (hours)
Output: probability of electricity overuse
≥ 0.5 → High overuse risk
< 0.5 → Normal usage
